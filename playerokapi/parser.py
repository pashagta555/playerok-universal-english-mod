...
def my_item(data: dict) -> "MyItem":
    ...
    return MyItem(
        ...
        sequence=data.get("sequence"),
        status_expiration_date=data.get("statusExpirationDate"),
        status_description=data.get("statusDescription"),status_payment=transaction(data.get("statusPayment")),
...
def moderator(data: dict) -> "Moderator": # TODO: Parse the Moderator class
    ...  


def event(data: dict): # TODO: Parse the Event class
    ...  
