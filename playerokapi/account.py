...
class Account:
    ...
    def get_chats(
        ...
        :param status: Status of the чатов, которые нужно получать. По умолчанию не указано, значит будут любые, _опционально_.
    ...
    def create_item(
        ...
        """
        Создаёт Item (после создания помещается в черновик, а не сразу выставляется на продажу).

        :param game_category_id: ID категории игры, в которой необходимо создать Item.
        :type game_category_id: `str`
        ...
        :param data_fields: Массив полей с данными предмета. \n
            ...
            Поля с типом `OBTAINING_DATA` **заполнять и передавать не нужно**, так как эти данные будет указывать сам Buyer при оформлении предмета.
    ...
    def remove_item(
        ...
        """
        Полностью удаляет Item вашего аккаунта.
    ...
    def increase_item_priority_status(
        ...
        """
        Повышает Status of the приоритета предмета.
    ...
    def get_transactions(
        ...
        :param min_value: Минимальная Price транзакции, _опционально_.
        :type min_value: `int` or `None`

        :param max_value: Максимальная Price транзакции, _опционально_.
        ...
        :param status: Status of the транзакции, _опционально_.
