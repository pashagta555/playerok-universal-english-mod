...
class Account:
    ...
    :param request_max_retries: Maximum number of retry attempts for request if CloudFlare protection was detected.
    ...
    def __init__(
        ...
        """Maximum number of retry attempts for request."""
    ...
    def get_games(
        ...
        :param type: Game type to get. If not specified, gets all at once, _optional_.
    ...
    def get_game_category(
        ...
        Can be obtained by parameter `id` or by combination of parameters `game_id` and `slug`
    ...
    def get_game_category_instructions(
        ...
        """
        Gets sale/purchase instructions in category.
    ...
    def get_transaction_providers(
        ...
        :return: Transaction providers list.
