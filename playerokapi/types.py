...
class AccountBalance:
    ...
    :param available: The amount of available balance.
    :type available: `int`
...
class AccountStats:
    ...
    :param deals: Transaction statistics.
...
class AccountProfile:
    ...
    :param support_chat_id: ID support chat.
    :type support_chat_id: `str`

    :param system_chat_id: ID system chat.
    :type system_chat_id: `str`

    :param has_frozen_balance: Is the account balance frozen?
    :type has_frozen_balance: `bool`

    :param has_enabled_notifications: Are notifications enabled on your account?
    ...
    def __init__(self, id: str, username: str, email: str, balance: AccountBalance, stats: AccountStats, role: UserTypes, avatar_url: str, is_online: bool, is_blocked: bool,
        ...
        """ ID account support chat. """
        self.system_chat_id: str = system_chat_id
        """ ID account system chat. """
...
class UserProfile:
    ...
    :param avatar_url: URL user avatar.
    :type avatar_url: `str`
    ...
    :param created_at: The date the user account was created.
    :type created_at: `str`
    """
    ...
    def get_items(
        ...
        :param count: The number of items to receive (no more than 24 per request), _optional_.
        :type count: `int`
        
        :param game_id: ID games/applications whose items need to be obtained are _optional_.
        :type game_id: `str` or `None`

        :param category_id: ID categories of the game/application whose items you need to obtain, _optional_.
        :type category_id: `str` or `None`

        :param status: An array of item types to obtain. Some statuses can only be obtained if this is your account profile. If not specified, gets all possible ones at once.
    ...
    def get_reviews(
        ...
        :param count: The number of reviews to receive (no more than 24 per request), _optional_.
        :type count: `int`

        :param status: The type of feedback you want to receive.
        ...
        :param category_id: ID review categories, _optional_.
        :type category_id: `str` or `None`

        :param min_item_price: Minimum price of the review item, _optional_.
        :type min_item_price: `bool` or `None`

        :param max_item_price: Maximum price of the item being reviewed, _optional_.
...
class ItemDeal:
    ...
    :param report_problem_enabled: Is appealing the problem included?
    ...
    :param review: Feedback on the deal.
    :type review: `playerokapi.types.Review` or `None`

    :param obtaining_fields: The resulting fields.
...
class ItemDealPageInfo:
    ...
    :param end_cursor: End of page mark.
    :type end_cursor: `str`

    :param has_previous_page: Does the previous page have.
    :type has_previous_page: `bool`

    :param has_next_page: Does the next page have.
...
class GameCategoryAgreement:
    ...
    :param sequence: Consistency of agreement.
    :type sequence: `str`
    """
...
class GameCategoryAgreementList:
    ...
    :param agreements: Page conventions.
...
class GameCategoryObtainingType:
    ...
    :param game_category_id: ID fashion game categories.
    ...
    :param sequence: Sequence of method.
    :type sequence: `int`
...
class GameCategoryDataField:
    ...
    :param id: ID data fields.
    :type id: `str`

    :param label: The inscription is the name of the field.
    :type label: `str`

    :param type: Data field type.
    :type type: `playerokapi.enums.GameCategoryDataFieldTypes`

    :param input_type: The type of field value to be entered.
    :type input_type: `playerokapi.enums.GameCategoryDataFieldInputTypes`

    :param copyable: Whether copying of a value from a field is allowed.
    :type copyable: `bool`

    :param hidden: Is the data hidden in the field?
    :type hidden: `bool`
...
class GameCategoryDataFieldList:
    ...
    :param data_fields: Fields with data for an item in a category on a page.
...
class GameCategoryOption:
    ...
    :param value_range_limit: Value spread limit.
...
class GameCategoryInstructionList:
    ...
    :param instructions: Instructions page.
...
class GameCategory:
    ...
    :param game_id: ID games category.
    :type game_id: `str` or `None`

    :param obtaining: Receipt type.
    ...
    :param use_custom_obtaining: Is custom receiving used?
    :type use_custom_obtaining: `bool`

    :param auto_confirm_period: Auto-confirmation period for transactions in this category.
...
class ItemPriorityStatus:
    ...
    :param period: Duration of status (in days).
    :type period: `str`

    :param price_range: Price range of a status item.
...
class Item:
    ...
    :param obtaining_type: Method of receipt.
    ...
    :param attachments: Application files.
...
class MyItem:
    ...
    :param seller_notified_about_fee_change: Has the seller been notified of the commission change?
    ...
    :param sequence: The item's position in the users' product table.
...
class TransactionPaymentMethod:
    ...
    :param provider_id: ID transaction provider.
...
class TransactionProviderLimits:
    ...
    :param outgoing: To the conclusion.
...
class TransactionProviderRequiredUserData:
    ...
    def __init__(self, email: bool, phone_number: bool, 
        ...
        """ Is it necessary to indicate the ERIP account number? """
...
class Transaction:
    ...
    :param created_at: The date the transaction was created.
    :type created_at: `str`

    :param verified_at: Transaction confirmation date.
    :type verified_at: `str` or `None`

    :param verified_by: An object of the user who confirmed the transaction.
    :type verified_by: `playerokapi.types.UserProfile` or `None`

    :param completed_at: The date the transaction was executed.
    :type completed_at: `str` or `None`

    :param completed_by: An object of the user who performed the transaction.
    :type completed_by: `playerokapi.types.UserProfile` or `None`

    :param payment_method_id: ID payment method.
...
class TransactionList:
    ...
    :param total_count: Total transactions per page.
    :type total_count: `int`
    """
...
class UserBankCard:
    ...
    :param is_chosen: Is this card selected as the default?
    :type is_chosen: `bool`
    """
...
class ChatMessage:
    ...
    :param is_read: Has the message been read?
    :type is_read: `bool`
    ...
    :param deal: The transaction to which the message relates.
    :type deal: `playerokapi.types.Deal` or `None`

    :param item: The item to which the message relates (usually only the deal itself is passed to the deal variable).
    :type item: `playerokapi.types.Item` or `None`

    :param transaction: Message transaction.
    :type transaction: `playerokapi.types.Transaction` or `None`

    :param moderator: Post moderator.
    :type moderator: `playerokapi.types.Moderator`

    :param event_by_user: User event.
    ...
    :param is_auto_response: Is it an auto-response?
...
class ChatMessageList:
    ...
    :param total_count: Total chat messages.
    :type total_count: `int`
    """
...
class Chat:
    ...
    :param deals: Transactions in chat.
    ...
    :param finished_at: Dialogue end date.
...
class Review:
    ...
    :param deal: Review related transaction.
    :type deal: `Deal`
