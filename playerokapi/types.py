...
class UserProfile:
    ...
    def get_items(
        ...
        :param game_id: ID of the game/application whose items you want to get, _optional_.
        :type game_id: `str` or `None`

        :param category_id: ID of the category of the game/application whose items you want to get, _optional_.
        :type category_id: `str` or `None`

        :param status: Array of item types to get. Some statuses can only be obtained if this is your account profile. If not specified, gets all possible ones at once.
    ...
    def get_reviews(
        ...
        :param max_item_price: Maximum price of a review item, _optional_.
        :type max_item_price: `bool` or `None`

        :param sort_direction: Sort type.
        :type sort_direction: `playerokapi.enums.SortDirections`

        :param sort_field: Field by which sorting will be performed (by default `createdAt` - by date)
        :type sort_field: `str`
...
class ItemDeal:
    """Deals object with item.

    :param id: ID deals.
    :type id: `str`

    :param status: Deals status.
    ...
    :param status_description: Description of the deals status.
    :type status_description: `str` or `None`

    :param direction: Direction of deals (buy/sell).
    :type direction: `playerokapi.enums.ItemDealDirections`

    :param obtaining: Getting deals.
    ...
    :param completed_at: Deals confirmation date.
    :type completed_at: `str` or `None`

    :param created_at: Date the deals were created.
    :type created_at: `str` or `None`

    :param logs: Deals logs.
    ...
    :param chat: Deals chat (only its ID is transmitted).
    ...
    def __init__(self, id: str, status: ItemDealStatuses, status_expiration_date: str | None, status_description: str | None, 
        ...
        "Chat deals (only its ID is transmitted)."
        self.item: Item = item
        "Item deals."
...
class GameCategoryDataField:
    """A subclass that describes fields with item data in a category (which are sent after purchase).
...
class GameCategoryDataFieldList:
    ...
    :param data_fields: Fields with item data in the category on the page.
    ...
    def __init__(self, data_fields: list[GameCategoryDataField], 
        ...
        "Fields with item data in a category on the page."
...
class ItemLog:
    """A subclass that describes the action log with an item.
...
class MyItem:
    ...
    :param sequence: The position of the item in the user item table.
    ...
    :param is_editable: Is it possible to edit the item.
    :type is_editable: `bool`

    :param approval_date: Date of publication of the item.
    :type approval_date: `str` or `None`

    :param deleted_at: Date the item was deleted.
    :type deleted_at: `str` or `None`

    :param updated_at: Date the item was last updated.
    :type updated_at: `str` or `None`

    :param created_at: Date the item was created.
    :type created_at: `str` or `None`"""
    ...
    def __init__(self, id: str, slug: str, name: str, description: str, obtaining_type: GameCategoryObtainingType | None, price: int, raw_price: int, priority_position: int,
        ...
        "The position of the item in the user items table."
        self.status_expiration_date: str | None = status_expiration_date
...
class ChatMessage:
    ...
    :param deal: Deal to which the message relates.
...
class Review:
    ...
    def __init__(self, id: str, status: ReviewStatuses, text: str | None, rating: int,
        ...
        "Deal associated with the review."
