...
class UserProfile:
    ...
    def get_items(
        ...
        :param game_id: Game/application ID whose items to get, _optional_.
        :type game_id: `str` or `None`

        :param category_id: Game/application category ID whose items to get, _optional_.
    ...
    def get_reviews(
        ...
        :param game_id: Reviews game ID, _optional_.
        :type game_id: `str` or `None`

        :param category_id: Reviews category ID, _optional_.
        :type category_id: `str` or `None`

        :param min_item_price: Minimum item price of review, _optional_.
        :type min_item_price: `bool` or `None`

        :param max_item_price: Maximum item price of review, _optional_.
...
class ItemDeal:
    ...
    :param chat: Deal chat (only its ID is passed).
    ...
    def __init__(self, id: str, status: ItemDealStatuses, status_expiration_date: str | None, status_description: str | None, 
        ...
        """ Deal chat (only its ID is passed). """
        self.item: Item = item
        """ Deal item. """
...
class GameCategoryObtainingType:
    ...
    :param agreements: Buyer agreements for purchase/seller agreements for sale.
    :type agreements: `list[playerokapi.types.GameCategoryAgreement]`
    ...
    def __init__(self, id: str, name: str, description: str, game_category_id: str, no_comment_from_buyer: bool,
        ...
        """ Fee multiplier. """
        self.agreements: list[GameCategoryAgreement] = agreements
        """ Buyer agreements for purchase/seller agreements for sale. """
...
class GameCategoryObtainingTypePageInfo:
    """
    Subclass describing item obtaining types (methods) page information in category.
...
class GameCategoryObtainingTypeList:
    """
    Class describing item obtaining types (methods) page in category.
...
class GameCategoryInstruction:
    """
    Subclass describing category sale/purchase instruction page information.
...
class GameCategoryInstructionPageInfo:
    """
    Subclass describing category sale/purchase instruction.
...
class GameCategoryInstructionList:
    """
    Class describing category sale/purchase instructions page.
...
class GameCategory:
    ...
    :param auto_confirm_period: Auto-confirmation period for this category's deals.
    ...
    def __init__(self, id: str, slug: str, name: str, category_id: str | None, game_id: str | None,
        ...
        """ Auto-confirmation period for this category's deals. """
...
class ItemLog:
    ...
    :param user: Profile of user who performed the log.
    :type user: `playerokapi.types.UserProfile`
    """
    def __init__(self, id: str, event: ItemLogEvents, created_at: str,
        ...
        """ Log creation date. """
        self.user: UserProfile = user
        """ Profile of user who performed the log. """
...
class TransactionList:
    """
    Class describing transactions page.
...
class Moderator:
    # TODO: Implement Moderator class
...
class ChatMessage:
    ...
    :param item: Item related to message (usually only the deal itself is passed to the deal variable).
    ...
    def __init__(self, id: str, text: str, created_at: str, deleted_at: str | None, is_read: bool, 
        ...
        """ Item related to message (usually only the deal itself is passed to the deal variable). """
        self.transaction: Transaction | None = transaction
        """ Message transaction. """
...
class Review:
    ...
    :param user: Seller profile to which the review relates.
    ...
    def __init__(self, id: str, status: ReviewStatuses, text: str | None, rating: int,
        ...
        self.user: UserProfile = user
        """ Seller profile to which the review relates. """
