...
def settings_restore_text():
    ...
    txt = textwrap.dedent(f"""
        ...
        On Playerok, as soon as your item is purchased - it disappears from sale. This feature will automatically restore (re-list) an item that was just purchased, so it's back on sale. The item will be listed with the same priority status as before.
