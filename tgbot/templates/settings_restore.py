...
def settings_restore_text():
    ...
    txt = textwrap.dedent(f"""
        ...
        This feature will automatically restore (re-list) an item that was just sold or expired, so it's back on sale. The item will be listed with the same priority status as before.
