...
def settings_restore_text():
    ...
    auto_restore_items_sold = "🟢 Enabled" if config["playerok"]["auto_restore_items"]["sold"] else "🔴 Off"
    auto_restore_items_expired = "🟢 Enabled" if config["playerok"]["auto_restore_items"]["expired"] else "🔴 Off"
    ...
    txt = textwrap.dedent(f"""
        ...
        <b>What kind of auto-recovery of items?</b>
