...
def settings_other_text ():
    ...
    custom_commands_enabled ="Enabled"if config ["playerok"]["custom_commands"]["enabled"]else "Shut Off"
    auto_deliveries_enabled ="Enabled"if config ["playerok"]["auto_deliveries"]["enabled"]else "Turned off"
...
def settings_other_kb ():
    ...
    switch_read_chat_enabled ="Enabled"if config ["playerok"]["read_chat"]["enabled"]else "Turned off"
