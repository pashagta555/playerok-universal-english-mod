...
def module_page_text(module_uuid: UUID):
    ...
    txt = textwrap.dedent(f"""
        ...
        🔌 <b>Condition:</b>{'🟢 Enabled' if module.enabled else '🔴 Off'}
    """)
    return txt
...
def module_page_kb(module_uuid: UUID, page: int = 0):
    ...
    rows = [
        [InlineKeyboardButton(text="🔴 Turn off module" if module.enabled else "🟢 Enable module", callback_data="switch_module_enabled")],
