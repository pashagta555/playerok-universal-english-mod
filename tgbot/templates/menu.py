...
def menu_kb ():
    rows =[
    [
    InlineKeyboardButton (text ="Settings",callback_data =calls .SettingsNavigation (to ="default").pack ()),
    ...
    InlineKeyboardButton (text ="Logs",callback_data =calls .MenuNavigation (to ="logs").pack ())
    ],
    [
    ...
    [
    InlineKeyboardButton (text ="Software Developer",url ="https://t.me/alleexxeeyy"),
