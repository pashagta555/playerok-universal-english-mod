...
def settings_restore_excluded_kb (page =0 ):
    ...
    InlineKeyboardButton (text ="Add multiple",callback_data ="send_new_excluded_restore_items_keyphrases_file"),
    ])
    rows .append ([
    InlineKeyboardButton (text ="Backwards ⬅️",callback_data =calls .SettingsNavigation (to ="restore").pack ()),
    ])
