...
def settings_deliv_page_kb(index: int, page: int = 0):
    ...
    rows = [
        [InlineKeyboardButton(text=f"⚡ Delivery type: {piece_str}", callback_data="switch_auto_delivery_piece")],
        ...
        [InlineKeyboardButton(text="🗑️Delete", callback_data="confirm_deleting_auto_delivery")],
