...
def settings_bump_text():
    ...
    auto_bump_items_enabled = "🟢 Enabled" if config["playerok"]["auto_bump_items"]["enabled"] else "🔴 Off"
    ...
    txt = textwrap.dedent(f"""
        ...
        <b>📦 Raise:</b>{auto_bump_items_all}
        <b>⏲️ Raising interval:</b>{auto_bump_items_interval} sec.

        <b>➕ Included:</b>{auto_bump_items_included}
        <b>➖ Excluded:</b>{auto_bump_items_excluded}

        <b>What is this auto-lifting of objects?</b>
