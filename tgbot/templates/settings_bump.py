...
def settings_bump_text ():
    ...
    txt =textwrap .dedent (f"""<b>⬆️ Auto-raising</b>

        <b>⬆️ Auto-raising items:</b>{auto_bump_items_enabled }<b>📦 Raise:</b>{auto_bump_items_all }<b>⏲️ Raising interval:</b>{auto_bump_items_interval }sec.

        <b>➕ Included:</b>{auto_bump_items_included }<b>➖ Excluded:</b>{auto_bump_items_excluded }<b>What is this auto-lifting of objects?</b>
...
def settings_bump_kb ():
    ...
    rows =[
    [InlineKeyboardButton (text =f"⬆️ Auto-lifting items:{auto_bump_items_enabled }",callback_data ="switch_auto_bump_items_enabled")],
    [InlineKeyboardButton (text =f"📦 Raise:{auto_bump_items_all }",callback_data ="switch_auto_bump_items_all")],
    [InlineKeyboardButton (text =f"⏲️ Lifting interval:{auto_bump_items_interval }sec.",callback_data ="enter_auto_bump_items_interval")],
    [
