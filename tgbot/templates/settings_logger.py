...
def settings_logger_text():
    ...
    txt = textwrap.dedent(f"""
        ...
        👀 <b>Logging Playerok events in Telegram:</b> {tg_logging_enabled}
...
def settings_logger_kb():
    ...
    event_deal_status_changed = "🟢" if tg_logging_events["deal_status_changed"] else "🔴"
    rows = [
        [InlineKeyboardButton(text=f"👀 Logging Playerok events in Telegram: {tg_logging_enabled}", callback_data="switch_tg_logging_enabled")],
