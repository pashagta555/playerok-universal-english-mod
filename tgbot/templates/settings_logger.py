...
def settings_logger_text():
    ...
    tg_logging_chat_id = config["playerok"]["tg_logging"]["chat_id"] or "✔️ Current chat with bot"
    ...
    txt = textwrap.dedent(f"""
        ...
        ・ {event_new_problem}  🤬 New deal complaint
...
def settings_logger_kb():
    ...
    rows = [
        ...
        [
        InlineKeyboardButton(text=f"{event_new_problem}  🤬 New deal complaint", callback_data="switch_tg_logging_event_new_problem"),
