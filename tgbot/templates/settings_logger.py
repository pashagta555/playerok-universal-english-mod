...
def settings_logger_text():
    ...
    txt = textwrap.dedent(f"""
        ...
        <b>📢 Events:</b>
        ・ {event_new_user_message} 👤 New message from the user
        ...
        ・ {event_deal_status_changed} 🔄️ Deal status has changed
    """)
    return txt
...
def settings_logger_kb():
    ...
    rows = [
        ...
        InlineKeyboardButton(text=f"{event_deal_status_changed} 🔄️ Deal status has changed", callback_data="switch_tg_logging_event_deal_status_changed")
        ],
