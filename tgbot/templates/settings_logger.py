...
def settings_logger_text():
    ...
    txt = textwrap.dedent(f"""
        ...
        ・ {event_new_problem}  🤬 New жалоба в сделке
        ・ {event_deal_status_changed}  🔄️ Status of the deal was changed
    """)
    return txt
...
def settings_logger_kb():
    ...
    rows = [
        ...
        [
        InlineKeyboardButton(text=f"{event_new_problem}  🤬 New жалоба в сделке", callback_data="switch_tg_logging_event_new_problem"),
