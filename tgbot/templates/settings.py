...
def settings_kb():
    rows = [
        ...
        [
            ...
            InlineKeyboardButton(text="♻️ Auto-restoration", callback_data=calls.SettingsNavigation(to="restore").pack())
        ],
        [
        ...
        [
            InlineKeyboardButton(text="⬆️ Auto-bump", callback_data=calls.SettingsNavigation(to="bump").pack()),
            InlineKeyboardButton(text="👀 Logger", callback_data=calls.SettingsNavigation(to="logger").pack())
        ],
        [InlineKeyboardButton(text="🔧 More", callback_data=calls.SettingsNavigation(to="other").pack())],
