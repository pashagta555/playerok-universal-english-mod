...
def settings_conn_text():
    ...
    txt = textwrap.dedent(f"""
        ...
        This is the maximum time for a response to come from the Playerok website. If the time expires and no response comes — the bot will show an error. If you have a weak internet connection, specify a larger value

        <b>What is request frequency to playerok.com?</b>
        How often requests will be sent to Playerok to get events. We do not recommend setting it below 4 seconds, as Playerok may simply ban your IP address, and you will no longer be able to send requests from it
