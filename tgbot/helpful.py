...
async def do_auth(message: Message, state: FSMContext) -> Message | None:
    ...
    return await throw_float_message(
        ...
        text=templ.sign_text(
            '🔑 Enter the password specified in the bot config ↓'
            '\n\n<span class="tg-spoiler">If you forgot it, open bot_settings/config.json and check telegram.bot.password</span>'
        ),
