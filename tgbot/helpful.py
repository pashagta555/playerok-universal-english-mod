...
async def do_auth(message: Message, state: FSMContext) -> Message | None:
    ...
    return await throw_float_message(
        ...
        text=templ.sign_text(
            '🔑 Enter the bot password key from your config ↓'
            '\n\n<span class="tg-spoiler">If you forgot it, you can find it in bot_settings/config.json, the password field under telegram.bot</span>'
        ),
