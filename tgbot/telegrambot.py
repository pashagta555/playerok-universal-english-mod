...
class TelegramBot :
    ...
    async def _set_main_menu (self ):
        try :
            ...
            BotCommand (command ="/restart",description ='🔄️ Reload')
            ]
    ...
    async def _set_short_description (self ):
        try :
            short_description =textwrap .dedent (f"""Playerok Universal is a free bot assistant for playerok.com
    ...
    async def _set_description (self ):
        try :
            description =textwrap .dedent (f"""🟢 Eternal online
                ...
                ⬇️ Download the bot: https://github.com/pashagta555/playerok-universal-english-mod
    ...
    async def notify_bot_restarted (self ):
        ...
        for user_id in config ["telegram"]["bot"]["signed_users"]:
            ...
            chat_id =user_id ,
            text ='✅ The bot was <b>successfully rebooted</b>',
