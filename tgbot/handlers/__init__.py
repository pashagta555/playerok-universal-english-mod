...
router = Router()
router.include_routers(commands_router, states_actions_router, states_system_router, states_settings_router, states_messages_router, states_restore_router, states_complete_router, states_bump_router, states_comms_router, states_delivs_router)