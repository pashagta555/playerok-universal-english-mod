...
async def handler_waiting_for_new_auto_delivery_keyphrases (message :types .Message ,state :FSMContext ):
    try :
        ...
        state =state ,
        message =message ,
        text =templ .settings_new_deliv_float_text (f"🛒 Select <b>auto-dispensing type</b>:"),
...
async def handler_waiting_for_auto_delivery_keyphrases (message :types .Message ,state :FSMContext ):
    try :
        ...
        state =state ,
        message =message ,
        text =templ .settings_deliv_page_float_text (f"✅ <b>Key phrases</b> have been successfully changed to: <code>{keyphrases_str }</code>"),
...
async def handler_waiting_for_auto_delivery_message (message :types .Message ,state :FSMContext ):
    try :
        ...
        state =state ,
        message =message ,
        text =templ .settings_deliv_page_float_text (f"✅ <b>The auto-issue message</b> was successfully changed to: <blockquote>{message .text }</blockquote>"),
        reply_markup =templ .back_kb (calls .AutoDeliveryPage (index =index ).pack ())
        )
    except Exception as e :
        await throw_float_message (
...
async def handler_waiting_for_auto_delivery_goods_add (message :types .Message ,state :FSMContext ):
    try :
        ...
        f"✅ <b>{len (goods )}products</b> successfully added to auto-issuance"
        ),
