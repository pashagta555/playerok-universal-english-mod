...
async def handler_waiting_for_cookies (message :types .Message ,state :FSMContext ):
    try :
        ...
        state =state ,
        message =message ,
        text =templ .settings_auth_float_text (f"🍪 <b>Cookie data</b> was successfully changed to: <blockquote>{str_cookies }</blockquote>"),
...
async def handler_waiting_for_sbp_bank_phone_number (message :types .Message ,state :FSMContext ):
    try :
        ...
        state =state ,
        message =message ,
        text =templ .settings_withdrawal_sbp_float_text (f"✅ <b>The output data of </b> was successfully changed to <b>{phone_number }(SBP)</b>"),
        reply_markup =templ .back_kb (calls .SettingsNavigation (to ="withdrawal").pack ())
        )
    except Exception as e :
        await throw_float_message (
...
async def handler_waiting_for_usdt_address (message :types .Message ,state :FSMContext ):
    try :
        ...
        state =state ,
        message =message ,
        text =templ .settings_withdrawal_float_text (f"✅ <b>The output data of </b> was successfully changed to <b>{address } (USDT TRC20)</b>"),
        reply_markup =templ .back_kb (calls .SettingsNavigation (to ="withdrawal").pack ())
        )
    except Exception as e :
        await throw_float_message (
