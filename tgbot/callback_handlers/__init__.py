...
router = Router()
router.include_routers(navigation_router, pagination_router, page_router, actions_enter_router, actions_switch_router, actions_other_router, actions_confirm_router)