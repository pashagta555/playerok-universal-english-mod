...
class PlayerokBot:
    ...
    def __init__(self):
        ...
        """Dictionary of last remembered chats. Format: {`chat_id` _or_ `username`: `chat_obj`, ...}"""
    ...
    def send_message(self, chat_id: str, text: str | None = None, photo_file_path: str | None = None,
        ...
        """
        Custom method for sending message to Playerok chat.
        Tries to send in 3 attempts, if failed - outputs error to console.\n
    ...
    def log_new_review(self, deal: ItemDeal):
        ...
        self.logger.info(f" · Left by: {Fore.LIGHTWHITE_EX}{deal.review.creator.username}")
    ...
    async def run_bot(self):
        self.logger.info(f"{Fore.GREEN}Playerok bot started and active")
        self.logger.info("")
        self.logger.info(f"{ACCENT_COLOR}───────────────────────────────────────")
