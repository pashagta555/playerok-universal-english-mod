...
def menu_text():
    txt = textwrap.dedent(f"""
        ...
        <b>{NAME}</b> v{VERSION}
        Module for filling in forms

        <b>Links:</b>
        ┣ <b>@alleexxeeyy</b> — main developer
        ┗ <b>@alexey_production_bot</b> — bot for buying official modules
...
def instruction_comms_text():
    txt = textwrap.dedent(f"""
        ...
        <code>!myform</code> — shows your filled form data
...
def settings_text():
    txt = textwrap.dedent(f"""
        ...
        Navigate below to change settings ↓
    """)
    return txt
...
def settings_mess_text():
    ...
    txt = textwrap.dedent(f"""
        ...
        Navigate below. Click a message to edit it ↓
    """)
    return txt
