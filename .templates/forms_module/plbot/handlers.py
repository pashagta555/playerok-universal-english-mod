...
def is_fullname_valid (fullname :str )->bool :
    pattern =r'^[A-Yaa-yaYoyo]+ [A-Yaa-yaYoyo]+ [A-Yaa-yaYoyo]+$'
...
async def handle_new_form_waiting_for_fullname (plbot :'PlayerokBot',event :NewMessageEvent ):
    ...
    if config ["playerok"]["bot"]["log_states"]:
        logger .info (f"{PREFIX } {Fore .LIGHTWHITE_EX }{event .message .user .username } {Fore .WHITE }indicated in the application the full name:{Fore .LIGHTWHITE_EX }{fullname }")
...
async def handle_new_form_waiting_for_hobby (plbot :'PlayerokBot',event :NewMessageEvent ):
    ...
    if config ["playerok"]["bot"]["log_states"]:
        logger .info (f"{PREFIX } {Fore .LIGHTWHITE_EX }{event .message .user .username } {Fore .WHITE }indicated in the questionnaire a hobby:{Fore .LIGHTWHITE_EX }{hobby }")
