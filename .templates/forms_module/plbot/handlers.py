...
async def handle_new_form_waiting_for_fullname(plbot: 'PlayerokBot', event: NewMessageEvent):
    ...
    if config["playerok"]["bot"]["log_states"]:
        logger.info(f"{PREFIX} {Fore.LIGHTWHITE_EX}{event.message.user.username} {Fore.WHITE}indicated full name in the form: {Fore.LIGHTWHITE_EX}{fullname}")
...
async def handle_new_form_waiting_for_hobby(plbot: 'PlayerokBot', event: NewMessageEvent):
    ...
    if config["playerok"]["bot"]["log_states"]:
        logger.info(f"{PREFIX} {Fore.LIGHTWHITE_EX}{event.message.user.username} {Fore.WHITE}indicated a hobby in the questionnaire: {Fore.LIGHTWHITE_EX}{hobby}")
