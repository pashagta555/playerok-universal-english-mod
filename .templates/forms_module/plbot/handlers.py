...
async def handle_new_form_waiting_for_fullname(plbot: 'PlayerokBot', event: NewMessageEvent):
    ...
    if config["playerok"]["bot"]["log_states"]:
        logger.info(f"{PREFIX} {Fore.LIGHTWHITE_EX}{event.message.user.username} {Fore.WHITE}entered full name: {Fore.LIGHTWHITE_EX}{fullname}")
...
async def handle_new_form_waiting_for_age(plbot: 'PlayerokBot', event: NewMessageEvent):
    ...
    if config["playerok"]["bot"]["log_states"]:
        logger.info(f"{PREFIX} {Fore.LIGHTWHITE_EX}{event.message.user.username} {Fore.WHITE}entered age: {Fore.LIGHTWHITE_EX}{age}")
...
async def handle_new_form_waiting_for_hobby(plbot: 'PlayerokBot', event: NewMessageEvent):
    ...
    if config["playerok"]["bot"]["log_states"]:
        logger.info(f"{PREFIX} {Fore.LIGHTWHITE_EX}{event.message.user.username} {Fore.WHITE}entered hobby: {Fore.LIGHTWHITE_EX}{hobby}")
