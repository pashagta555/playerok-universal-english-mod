...
class DataFile:
    ...
    path: str
    default: list | dict
INITIALIZED_USERS = DataFile(name='initialized_users', path='bot_data/initialized_users.json', default=[])
SAVED_ITEMS = DataFile(name='saved_items', path='bot_data/saved_items.json', default=[])
CACHED_ORDERS = DataFile(name='cached_orders', path='bot_data/cached_orders.json', default={})
LATEST_EVENTS_TIMES = DataFile(name='latest_events_times', path='bot_data/latest_events_times.json', default={'auto_bump_items': None, 'auto_withdrawal': None})
