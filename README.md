...
[![modules](https://img.shields.io/badge/%F0%9F%A7%A9%20modules-bot-green?style=for-the-badge)](https://t.me/alexey_production_bot)
...
- Always-online mode on the site
- Auto-restore of items
- Auto-bump items
...
3. Run `install_requirements.bat` and wait until all required libraries are installed
...
| Event | Trigger | Passed arguments |
  |-------|------------------|------------------------|
...
| `EventTypes.NEW_REVIEW` | New review of the deal | `PlayerBot`, `NewReviewEvent` |
