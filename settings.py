    ...
    default={
        "first_message": {
            ...
            "text": [
                ...
                "",
                "💡 If you want to talk to the seller, type the !seller command so I can invite them to this dialog",
                "",
                "To see all my commands, type !commands"
            ]
        },
        "cmd_error": {
            "enabled": True,
        ...
        "cmd_seller": {
            "enabled": True,
            "text": [
                "💬 The seller has been called to this chat. Please wait for them to join the dialog..."
            ]
        },
        "new_deal": {
            "enabled": False,
        ...
        "deal_pending": {
            "enabled": False,
            "text": [
                "⌛ Please send the required information so I can complete your order"
            ]
        },
        "deal_sent": {
            "enabled": False,
            "text": [
                "✅ I have confirmed the completion of your order! If you did not receive the purchased item, please write about it in the chat"
            ]
        },
        "deal_confirmed": {
            "enabled": False,
            "text": [
                "🌟 Thank you for a successful deal. I would be glad if you leave a review. See you in my store next time, good luck!"
            ]
        },
        "deal_refunded": {
            "enabled": False,
            "text": [
                "📦 The order has been refunded. I hope this deal did not cause you any inconvenience. See you in my store next time, good luck!"
            ]
        },
        "new_review": {
            "enabled": False,
            "text": [
                "✨ Thank you for the {review_rating}⭐ review! I hope you enjoyed the quality of the work performed"
            ]
        }
    }
)
...
def validate_config(config, default):
    """
    Validates config structure against the default template.
...
def restore_config(config: dict, default: dict):
    ...
    Also replaces invalid types with defaults.
...
def get_json(path: str, default: dict, need_restore: bool = True) -> dict:
    ...
    Restores/extends it when needed.
    ...
    :param need_restore: Whether to validate/restore config integrity.
