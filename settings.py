...
MESSAGES = SettingsFile(
    ...
    default={
        ...
        "cmd_seller": {
            "enabled": True,
            "text": [
                "💬 Seller was called to this chat. Wait for him to join the dialogue..."
            ]
        },
        "new_deal": {
            "enabled": False,
        ...
        "deal_sent": {
            "enabled": False,
            "text": [
                "✅ I have confirmed the completion of your order! If you have not received the purchased item, write it in the chat"
            ]
        },
        "deal_confirmed": {
            "enabled": False,
        ...
        "new_review": {
            "enabled": False,
            "text": [
                "✨ Thank you for {review_rating}⭐ review! I hope you liked the quality of the work done"
            ]
        }
    }
)
