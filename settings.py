...
'enabled':True ,
'text':[
"👋 Hello {username}, I'm a bot assistant",
'',
...
''
'The seller may not be available right now; to call him, use the !seller command.'
]
},
'deal_pending':{
'enabled':False ,
'text':[
'⌛ Send the necessary data so that I can complete your order'
]
},
'deal_sent':{
'enabled':False ,
...
'enabled':False ,
'text':[
'✨ Thank you for your {review_rating}⭐ review! I hope you liked the quality of the work done'
]
}
}
)
...
def restore_config (config :dict ,default :dict ):
    'Restores missing parameters in the configuration from the default template.\n    It removes parameters from the configuration that are not included in the standard template.\n\n    :param config: Current config.\n    :type config: `dict`\n\n    :param default: The default template configuration.\n    :type default: `dict`\n\n    :return: Restored config.\n    :rtype: `dict`'
