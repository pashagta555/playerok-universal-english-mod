...
def check_and_configure_config():
    ...
    while not config["telegram"]["api"]["token"]:
        print(
            f"\n{Fore.WHITE}Enter your Telegram bot's {Fore.CYAN}token{Fore.WHITE}. You need to create the bot with @BotFather."
    ...
    while not config["telegram"]["bot"]["password"]:
        print(
            f"\n{Fore.WHITE}Create and enter a {Fore.YELLOW}password for your Telegram bot{Fore.WHITE}. The bot will request this password on each new attempt by an unauthorized user to interact with your Telegram bot."
