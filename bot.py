...
if __name__ == '__main__':
    try:
        ...
        traceback.print_exc()
        print(f'\n\n{Fore.LIGHTRED_EX}Your bot encountered an unexpected error and was turned off.\n\n{Fore.WHITE}Пожалуйста, попробуйте найти свою проблему в нашей статье, в которой собраны все самые частые ошибки.', f'\nArticle: {Fore.LIGHTWHITE_EX}https://telegra.ph/FunPay-Universal--chastye-oshibki-i-ih-resheniya-08-26 {Fore.WHITE}(CTRL + Клик ЛКМ)\n\n')
